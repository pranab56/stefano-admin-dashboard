        ...
        <div className="w-full max-w-md p-8 rounded-lg bg-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 border ${errors.newPassword ? 'border-red-500' : 'border-gray-300'
                    } rounded-md focus:outline-none focus:ring-2 focus:ring-[#D3AB50] focus:border-transparent transition-all pr-12`}
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full bg-[#D3AB50] hover:bg-[#7a3a71] cursor-pointer text-white font-medium py-3 px-4 rounded-md transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <div className="text-center text-sm text-gray-600 mt-4">
              ...
              <Link
                href="/auth/login"
                className="text-[#D3AB50] hover:text-[#7a3a71] font-medium"
              >
                Back to Login
              </Link>
            </div>
